...
- `simple_force_massage.cpp`
  ...
  このプログラムは，マッサージのデモで使用しました．人間をsin波でマッサージします．力覚センサを使用して手先反力を計測し，P制御により，与える力が一定になるように制御します．ただ，Pゲインを適当に設定したため，振動します．マッサージ的には丁度いいかもしれませんが．．また，手先位置，力，速度指令をログとして記録します． 